...
(function (ColTs) {
    var Col = (function () {
        ...
        Col.prototype.groupBy = function (keySelector) {
            if (keySelector === void 0) { keySelector = function (e) { return e.toString(); }; }
...
(function (ColTs) {
    var Map = (function (_super) {
        ...
        Map.prototype.toHashmap = function (keySelector, valueSelector) {
            return ColTs.MapHelper.toHashmap(this.source, keySelector, valueSelector);
        };
        return Map;
    })(ColTs.Col);
    ColTs.Map = Map;
...
(function (ColTs) {
    var MapHelper = (function () {
        ...
        MapHelper.toHashmap = function (source, keySelector, valueSelector) {
            var hashmap = {};
            for (var i = 0; i < source.length; i++) {
                var item = source[i];
...
var Col = ColTs.Col;
var Map = ColTs.Map;
var ExamplesWithColTS = (function () {
    function ExamplesWithColTS() {
    }
    ExamplesWithColTS.findMostFiveCommonWordAndTheirOccurrences = function (text) {
        var cleanText = text.replace(/[^a-zA-Z0-9\s]/g, "");
        return Col.of(cleanText.split(" "))
            .groupBy()
            .select(function (e) {
            return {
                'word': e.key,
            ...
            .orderByDesc(function (e) { return e.count; }).take(5).toArray();
    };
    ExamplesWithColTS.countfavoriteFruitsFromPeopleAbove30 = function (data) {
        return Col.of(data).where(function (e) { return e.age > 30; }).groupBy(function (e) { return e.favoriteFruit; }).selectValues(function (e) { return e.value.length; }).toHashmap(function (key) { return key; }, function (val) { return val; });
    };
    ExamplesWithColTS.avarageBalancePerDecade = function (data) {
        return Col.of(data).groupBy(function (e) { return Math.floor(e.age / 10).toString(); }).toHashmap(function (e) { return e + "0s"; }, function (arr) { return Col.of(arr).average(function (e) { return parseFloat(e.balance.replace(/[^0-9\.]/g, "")); }); });
    };
    return ExamplesWithColTS;
})();
var res = ExamplesWithColTS.findMostFiveCommonWordAndTheirOccurrences("la99 li lu la99 ,sdf,,,,//.,mm");
...
var res2 = ExamplesWithColTS.countfavoriteFruitsFromPeopleAbove30(data);
console.log(JSON.stringify(res2));
var res3 = ExamplesWithColTS.avarageBalancePerDecade(data);
console.log(JSON.stringify(res3));
//# sourceMappingURL=withcol.js.map