...
var ExamplesWithoutColts = (function () {
    function ExamplesWithoutColts() {
    }
    ExamplesWithoutColts.findMostFiveCommonWordAndTheirOccurrences = function (text) {
        ...
        var sortedArray = resultArray.sort(function (objA, objB) {
    ...
    ExamplesWithoutColts.countfavoriteFruitsFromPeopleAbove30 = function (data) {
        var filteredData = data.filter(function (record) { return record.age > 30; });
        var counter = {};
    ...
    ExamplesWithoutColts.avarageBalancePerDecade = function (data) {
        var counter = {};
        data.forEach(function (e) {
            var decade = (Math.floor(e.age / 10)).toString();
            if (!counter[decade]) {
                counter[decade] = {
                    balance: 0,
                    amount: 0
...
//# sourceMappingURL=withoutcol.js.map